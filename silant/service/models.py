...
class Car(models.Model):
    ...
    model_drive_bridge = models.ForeignKey(references.ModelDriveBridge, on_delete=models.PROTECT, verbose_name='Модель ведущего моста')
    factory_number_drive_bridge = models.CharField(max_length=128, verbose_name='Зав. № ведущего моста')

    controlled_bridge_model = models.ForeignKey(references.ControlledBridgeModel, on_delete=models.PROTECT, verbose_name='Модель управляемого моста')
    ...
    service_company = models.OneToOneField(references.ServiceCompany, on_delete=models.PROTECT, verbose_name='Сервисная компания')
...
class TechnicalMaintenance(models.Model):
    ...
    organization_maintenance = models.ForeignKey(references.OrganizationMaintenance, on_delete=models.PROTECT, verbose_name='Организация, проводившая ТО')
    car = models.ForeignKey(Car, on_delete=models.PROTECT, verbose_name='Машина')
    service_company = models.ForeignKey(references.ServiceCompany, on_delete=models.PROTECT, verbose_name='Сервисная компания')
...
class Complaints(models.Model):
    ...
    recovery_method = models.ForeignKey(references.RecoveryMethod, on_delete=models.PROTECT, verbose_name='Способ восстановления')
    ...
    service_company = models.ForeignKey(references.ServiceCompany, on_delete=models.PROTECT, verbose_name='Cервисная компания')
    ...
    def save(self, *args, **kwargs):
        self.duration = (self.date_restoration - self.date_refusal).total_seconds()
